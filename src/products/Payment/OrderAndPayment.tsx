...
const OrderAndPayment = () => {
  ...
  console.log("chwilowy", chwilowy);

  setDataWithDeliveryAdress(chwilowy);
  console.log("data with delivery adress", dataWithDeliveryAdress); /// tutaj jest wszystko
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Input
                      ...
                      onChange={(event) => {
                        handleChange("firstAndSecondName", event.target.value);
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Input
                      ...
                      onChange={(event) => {
                        handleChange("streetAndHomeNumber", event.target.value);
                        field.onChange(event);
                      }}
                    />
                  )}
